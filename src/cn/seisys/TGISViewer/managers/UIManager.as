...
//        }
    ...
    private function setViewerStyle():void
    {
		...
		if ( configData.styleNavigationColors.length > 4 )
		{
			var textColorNavi:uint = configData.styleNavigationColors[0];
			var backgroundColorNavi:uint = configData.styleNavigationColors[1];
			var rolloverColorNavi:uint = configData.styleNavigationColors[2];
			var selectionColorNavi:uint = configData.styleNavigationColors[3];
			var titleColorNavi:uint = configData.styleNavigationColors[4];
			
			cssStyleDeclarationGlobal.setStyle("colorNavi", textColorNavi);
			cssStyleDeclarationGlobal.setStyle("contentBackgroundColorNavi", backgroundColorNavi);
			cssStyleDeclarationGlobal.setStyle("rollOverColorNavi", rolloverColorNavi);
			cssStyleDeclarationGlobal.setStyle("selectionColorNavi", selectionColorNavi);
			cssStyleDeclarationGlobal.setStyle("focusColorNavi", titleColorNavi);
		}
        ...
        if (cssStyleDeclarationApplication)
        {
            ...
            cssStyleDeclarationApplication.setStyle("backgroundAlpha", configData.applicationBackgroundAlpha);
        }
        ...
        var cssStyleDeclarationWT:CSSStyleDeclaration = topLevelStyleManager.getStyleDeclaration("cn.seisys.TGISViewer.WidgetTemplate");
        ...
        */
        ...
        if (numberOfStyleColors > 4)
        {
            cssStyleDeclarationWidgetTitle.setStyle("color", textColorNavi);
        }
        ...
        if (numberOfStyleColors > 4)
        {
            ...
            cssStyleDeclarationRET.setStyle("focusedTextSelectionColor", selectionColor);
            cssStyleDeclarationRET.setStyle("unfocusedTextSelectionColor", selectionColor);
